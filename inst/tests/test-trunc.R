...
inits <- list(mu = 2)
data <- list(x = 1)
testBUGSmodel(example = 'basic T() test', model = filename,
...
inits <- list(mu = 2)
data <- list(x = -2)
testBUGSmodel(example = 'left-truncated T() test', model = filename,
              data = data, inits = inits)
...
inits <- list(mu = 2)
data <- list(x = -2)
testBUGSmodel(example = 'non-truncated T() test', model = filename,
              data = data, inits = inits)
...
inits <- list(mu = 2)
data <- list(x = 2)
testBUGSmodel(example = 'basic I() test', model = filename,
              data = data, inits = inits)
...
inits <- list(mu = 2, b = 1)
data <- list(x = 2)
testBUGSmodel(example = 'test of T() with stochastic truncation and expressions', model = filename,
              data = data, inits = inits)
